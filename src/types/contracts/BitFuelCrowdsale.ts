...
export interface BitFuelCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface BitFuelCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BitFuelCrowdsaleInterface;
